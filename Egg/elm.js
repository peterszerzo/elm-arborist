...
var _user$project$Egg_Styles$text = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'margin', _1: '0'},
	_1: {
		ctor: '::',
...
var _user$project$Egg_Styles$nodeContainer = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'width', _1: '100%'},
	_1: {
		ctor: '::',
...
var _user$project$Egg_Styles$box = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'margin', _1: 'auto'},
	_1: {ctor: '[]'}
};
var _user$project$Egg_Styles$black = '#090B09';
var _user$project$Egg_Styles$faintGray = '#D1D7D4';
var _user$project$Egg_Styles$gray = '#828481';
var _user$project$Egg_Styles$orange = '#F18F01';
var _user$project$Egg_Styles$green = '#197753';
var _user$project$Egg_Styles$raw = A2(
	_elm_lang$core$Basics_ops['++'],
	'\n* {\n  -webkit-font-smoothing: antialiased;\n  box-sizing: border-box;\n  font-family: \'PT Sans\', sans-serif;\n}\n\nh1 {\n  margin: 0;\n}\n\np {\n  margin: 6px 0 0 0;\n}\n\na {\n  text-decoration: none;\n  color: inherit;\n  border-bottom: 1px solid currentColor;\n  line-height: 1;\n}\n\na:hover {\n  color: ',
	A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Egg_Styles$green,
		A2(
			_elm_lang$core$Basics_ops['++'],
			';\n}\n\ninput, textarea {\n  outline: none;\n  display: block;\n  width: 100%;\n  padding: 4px 8px;\n  margin-top: 4px;\n  border-radius: 4px;\n  border: 1px solid ',
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Egg_Styles$faintGray,
				A2(
					_elm_lang$core$Basics_ops['++'],
						...
						A2(
							...
							A2(
								...
								A2(
									...
									A2(
										_elm_lang$core$Basics_ops['++'],
										_user$project$Egg_Styles$gray,
										A2(
											_elm_lang$core$Basics_ops['++'],
											';\n  display: block;\n}\n\nlabel:not(:first-of-type) {\n  margin-top: 15px;\n}\n\ninput,\nlabel,\np,\nbutton,\na {\n  font-size: 0.875rem;\n}\n\ninput,\nlabel,\np {\n  line-height: 1.6;\n}\n\nbutton {\n  margin-top: 10px;\n}\n\nbutton:focus {\n  outline: none;\n  box-shadow: 0 0 3px ',
											A2(_elm_lang$core$Basics_ops['++'], _user$project$Egg_Styles$green, ';\n}\n'))))))))))));
var _user$project$Egg_Styles$popup = {
	ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'border-top',
					_1: A2(_elm_lang$core$Basics_ops['++'], '4px solid ', _user$project$Egg_Styles$green)
				},
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'box-shadow', _1: '0 0 12px rgba(0, 0, 0, 0.2)'},
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$Egg_Styles$button = {
	ctor: '::',
	_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$Egg_Styles$green},
	_1: {
		ctor: '::',
...
var _user$project$Egg_Styles$lightBlue = '#347A9A';
var _user$project$Egg_Styles$blue = '#046896';

var _user$project$Egg_Main$firstOpeningTag = function (code) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'Tag',
		A2(
			_elm_lang$core$Maybe$map,
			function (index) {
				return A2(_elm_lang$core$String$left, index + 1, code);
			},
			_elm_lang$core$List$head(
				A2(_elm_lang$core$String$indices, '>', code))));
};
var _user$project$Egg_Main$nodeView = F2(
			...
			A2(
				_elm_lang$html$Html$div,
				{
					...
					_0: _elm_lang$html$Html_Attributes$style(
						A2(
							_elm_lang$core$Basics_ops['++'],
							_user$project$Egg_Styles$nodeContainer,
							A2(
								_elm_lang$core$Basics_ops['++'],
								{
									ctor: '::',
								...
								function () {
									...
									switch (_p0.ctor) {
										...
										case 'DropTarget':
											return {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'background-color', _1: _user$project$Egg_Styles$orange},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'border', _1: '0'},
													_1: {
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(_user$project$Egg_Styles$text),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									_user$project$Egg_Styles$nodeContainer,
									{
										...
										_0: {
											...
											_1: function () {
												...
												switch (_p1.ctor) {
													case 'Active':
														return _user$project$Egg_Styles$green;
													case 'Hovered':
														return _user$project$Egg_Styles$lightBlue;
													case 'DropTarget':
														return _user$project$Egg_Styles$orange;
													default:
														return _user$project$Egg_Styles$blue;
												}
											}()
										},
										_1: {
						...
						},
						{
							...
							_0: A2(
								...
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(
										_user$project$Egg_Main$firstOpeningTag(item.code)),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						});
...
var _user$project$Egg_Main$textareaStyle = {
	ctor: '::',
	...
	_1: {
		...
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.25rem'},
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$Egg_Main$viewHeader = A2(
								...
								_1: {
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#001122'},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'font-size', _1: '1.5rem'},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'color', _1: '#FFF'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'border-bottom', _1: '1px solid #454545'},
															_1: {ctor: '[]'}
														}
													}
												}
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Egg'),
		_1: {ctor: '[]'}
	});
var _user$project$Egg_Main$tree = A2(
	...
	{code: '<div>\n  {props.children}\n</div>'},
	{
		...
		_0: A2(
			_user$project$Arborist$node,
			{code: '<header>I\'m Egg{props.children}</header>'},
			{ctor: '[]'}),
		_1: {
			ctor: '::',
			_0: A2(
				_user$project$Arborist$node,
				{code: '<main>World</main>'},
				{
					ctor: '::',
					_0: A2(
						_user$project$Arborist$node,
						{code: '<code>const a;</code>'},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					_user$project$Arborist$node,
					{code: '<footer>Made with a frying pan at ...</footer>'},
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: A2(
...
var _user$project$Egg_Main$code = _elm_lang$core$Native_Platform.outgoingPort(
	'code',
	function (v) {
		return v;
	});
var _user$project$Egg_Main$update = F2(
	function (msg, model) {
		var flatTree = _user$project$Arborist$flatten(
			_user$project$Arborist$tree(model.arborist));
		var sourceCode = A2(
			_elm_lang$core$String$join,
			'\n\n',
			A2(
					...
					var pathPrefix = function (_p4) {
						return A2(
							...
							A2(
								_elm_lang$core$List$map,
								function (i) {
									return _elm_lang$core$Basics$toString(i + 1);
								},
								_p4));
					}(_p10);
					var childrenCount = _elm_lang$core$List$length(
						A2(
							_elm_lang$core$List$filter,
							function (_p5) {
								var _p6 = _p5;
								...
								return _elm_lang$core$Native_Utils.eq(
									A2(
										...
										_p7),
									_p10) && _elm_lang$core$Native_Utils.eq(
									_elm_lang$core$List$length(_p7),
									_elm_lang$core$List$length(_p10) + 1);
							},
							flatTree));
					var prefixedCode = A4(
						_elm_lang$core$Regex$replace,
						_elm_lang$core$Regex$All,
						_elm_lang$core$Regex$regex('{props.children}'),
						function (_p8) {
							return A2(
								_elm_lang$core$String$join,
								'',
								A2(
									...
									A2(
										_elm_lang$core$List$map,
										_elm_lang$core$Basics$toString,
										A2(_elm_lang$core$List$range, 1, childrenCount))));
						},
						A4(
							_elm_lang$core$Regex$replace,
							_elm_lang$core$Regex$All,
							_elm_lang$core$Regex$regex('<Child'),
							function (_p9) {
								return A2(_elm_lang$core$Basics_ops['++'], '<Child', pathPrefix);
							},
							_p3._1.code));
					return A2(
						_elm_lang$core$Basics_ops['++'],
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								' (props) {\n return ',
								A2(_elm_lang$core$Basics_ops['++'], prefixedCode, '\n}'))));
				},
				flatTree));
		var _p11 = msg;
		switch (_p11.ctor) {
			case 'ArboristMsg':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							arborist: A2(_user$project$Arborist$update, _p11._0, model.arborist)
						}),
					_1: _user$project$Egg_Main$code(
						_elm_lang$core$Json_Encode$object(
							{
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'sourcecode',
									_1: _elm_lang$core$Json_Encode$string(sourceCode)
								},
								_1: {ctor: '[]'}
							}))
				};
			case 'SetActive':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							arborist: A2(_user$project$Arborist$setActiveNode, _p11._0, model.arborist)
						}),
			...
			case 'EditNewNodeCode':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							newNode: {code: _p11._0}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				var _p13 = _p11._0.width;
				var _p12 = _p11._0.height;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							arborist: A3(_user$project$Arborist$resize, (_p13 / 2) | 0, _p12, model.arborist),
							windowSize: {width: _p13, height: _p12}
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});
var _user$project$Egg_Main$Node = function (a) {
	return {code: a};
};
var _user$project$Egg_Main$Model = F3(
	function (a, b, c) {
		return {arborist: a, newNode: b, windowSize: c};
	});
var _user$project$Egg_Main$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _user$project$Egg_Main$init = {
	ctor: '_Tuple2',
	_0: {
		arborist: A2(
			...
			{
				ctor: '::',
				_0: A2(_user$project$Arborist_Settings$centerOffset, 0, -180),
				_1: {
					ctor: '::',
					_0: _user$project$Arborist_Settings$nodeHeight(30),
					_1: {
						ctor: '::',
						_0: _user$project$Arborist_Settings$level(80),
						_1: {
							ctor: '::',
							_0: _user$project$Arborist_Settings$nodeWidth(100),
							_1: {
								ctor: '::',
								_0: _user$project$Arborist_Settings$connectorStrokeAttributes(
									{
										ctor: '::',
										_0: _elm_lang$svg$Svg_Attributes$stroke('#454545'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
			...
			_user$project$Egg_Main$tree),
		newNode: {code: ''},
		windowSize: {width: 0, height: 0}
	},
	_1: A2(_elm_lang$core$Task$perform, _user$project$Egg_Main$Resize, _elm_lang$window$Window$size)
};
var _user$project$Egg_Main$DeleteActive = {ctor: 'DeleteActive'};
var _user$project$Egg_Main$SetActive = function (a) {
	return {ctor: 'SetActive', _0: a};
};
var _user$project$Egg_Main$EditNewNodeCode = function (a) {
	return {ctor: 'EditNewNodeCode', _0: a};
};
var _user$project$Egg_Main$ArboristMsg = function (a) {
	return {ctor: 'ArboristMsg', _0: a};
};
var _user$project$Egg_Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
			...
			{
				ctor: '::',
				_0: _user$project$Egg_Main$viewHeader,
				_1: {
					ctor: '::',
					_0: A3(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_user$project$Egg_Styles$raw),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('playground-container'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$style(
								{
										...
										_1: {
											...
											_1: {
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'height', _1: 'calc(100% - 60px)'},
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'z-index', _1: '10000'},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'border-left', _1: '1px solid #dedede'},
																_1: {ctor: '[]'}
															}
														}
													}
					...
					_0: A2(
							...
							_0: _elm_lang$html$Html_Attributes$style(
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#232323'},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'top', _1: '60px'},
												_1: {
													...
													_1: {
														...
														_0: {
															...
															_1: A2(
																_elm_lang$core$Basics_ops['++'],
																_elm_lang$core$Basics$toString((model.windowSize.width / 2) | 0),
																'px')
														},
														_1: {
															ctor: '::',
															_0: {
																...
																_1: A2(
																	_elm_lang$core$Basics_ops['++'],
																	_elm_lang$core$Basics$toString(model.windowSize.height - 60),
																	'px')
															},
															_1: {ctor: '[]'}
														}
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								...
								_0: A2(
									_elm_lang$html$Html$map,
									_user$project$Egg_Main$ArboristMsg,
									A3(
										_user$project$Arborist$view,
										_user$project$Egg_Main$nodeView,
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$style(_user$project$Egg_Styles$box),
											_1: {ctor: '[]'}
										},
										model.arborist)),
								_1: {ctor: '[]'}
											...
											_0: A2(
												_elm_lang$html$Html$div,
												{
													...
													_0: _elm_lang$html$Html_Attributes$style(
														A2(
															_elm_lang$core$Basics_ops['++'],
															_user$project$Egg_Styles$popup,
															{
																ctor: '::',
																_0: {
																	ctor: '_Tuple2',
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'height', _1: '320px'},
																		_1: {
																			ctor: '::',
													...
													if (_p17.ctor === 'Just') {
														...
														return {
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$style(_user$project$Egg_Main$textareaStyle),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$value(_p18.code),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(
																				function (val) {
																					return _user$project$Egg_Main$SetActive(
																						_elm_lang$core$Native_Utils.update(
																							_p18,
																							{code: val}));
																				}),
															...
															_1: {
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$style(_user$project$Egg_Styles$button),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(_user$project$Egg_Main$DeleteActive),
																			_1: {ctor: '[]'}
																		}
																	},
																	{
														...
														return {
															...
															_0: A2(
																_elm_lang$html$Html$textarea,
																{
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$value(model.newNode.code),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onInput(_user$project$Egg_Main$EditNewNodeCode),
																			_1: {ctor: '[]'}
																		}
																	}
																},
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_0: _elm_lang$html$Html_Events$onClick(
																					_user$project$Egg_Main$SetActive(model.newNode)),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
...
var _user$project$Egg_Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$window$Window$resizes(_user$project$Egg_Main$Resize),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Egg_Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Egg_Main$init, update: _user$project$Egg_Main$update, view: _user$project$Egg_Main$view, subscriptions: _user$project$Egg_Main$subscriptions})();

var Elm = {};
Elm['Egg'] = Elm['Egg'] || {};
Elm['Egg']['Main'] = Elm['Egg']['Main'] || {};
if (typeof _user$project$Egg_Main$main !== 'undefined') {
    _user$project$Egg_Main$main(Elm['Egg']['Main'], 'Egg.Main', undefined);
}
